...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.deTitleLabel.frame = CGRectOffset(self.deTitleLabel.frame, 70.0f, 1.0f);
        ...
        self.deSubtitleLabel.frame = CGRectOffset(self.deSubtitleLabel.frame, 70.0f, 27.0f);
        ...
        self.dePhotoImageView.frame = CGRectOffset(self.dePhotoImageView.frame, 20.0f, 5.0f);
